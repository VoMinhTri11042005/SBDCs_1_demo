...
import { getScopedSetting, setScopedSetting } from "../utils/userSettings";
...
export default function Login() {
  ...
  const processSteps = [
    [
      "01",
      "Đăng nhập/Tạo hồ sơ",
      "Số điện thoại giúp mở hồ sơ người hiến nhanh chóng.",
    ],
    [
      "02",
      "Kiểm tra điều kiện",
      "Hệ thống kiểm tra tuổi, cân nặng, chu kỳ hiến và dữ liệu sức khỏe.",
    ],
    [
      "03",
      "Đặt lịch trước",
      "Chọn thời gian phù hợp để tiết kiệm thời gian khi đến bệnh viện.",
    ],
    [
      "04",
      "Đến bệnh viện",
      "Mang giấy tờ tùy thân và hoàn tất sàng lọc y tế cuối cùng.",
    ],
  ];
  ...
  const benefitItems = [
    [
      HeartPulse,
      "Cứu sống mạng người",
      "Một đơn vị máu có thể hỗ trợ điều trị cho nhiều bệnh nhân cần truyền máu.",
    ],
    [
      Activity,
      "Kiểm tra sức khỏe miễn phí",
      "Được khám, tư vấn sức khỏe và làm các xét nghiệm sàng lọc trước khi hiến.",
    ],
    [
      HeartHandshake,
      "Tạo tác động nhân văn",
      "Mỗi lần hiến máu góp phần duy trì nguồn máu an toàn cho cộng đồng.",
    ],
  ];
  ...
  const avoidItems = [
    [
      XCircle,
      "Không để bụng đói",
      "Ăn nhẹ trước khi đến, tránh đồ ăn nhiều dầu mỡ.",
    ],
    ...
    [
      XCircle,
      "Tránh vận động mạnh",
      "Sau khi hiến nên nghỉ ngơi và uống đủ nước.",
    ],
  ];
    ...
    <div className="min-h-screen bg-[#f6f8fb] text-slate-950">
      ...
      <main className="lg:mr-[288px]">
            ...
            <div className="flex min-h-[360px] items-center rounded-[2rem] bg-white p-6 shadow-xl shadow-slate-200/70 ring-1 ring-slate-100 md:p-8">
              <div className="max-w-xl">
                <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-red-50 px-4 py-2 text-sm font-black text-red-600 ring-1 ring-red-100">
                  ...
                  Cùng lan tỏa nghĩa cử hiến máu nhân đạo
                </div>
                ...
                <h1 className="text-4xl font-black leading-[1.06] tracking-tight text-slate-950 md:text-5xl xl:text-6xl">
                  ...
                  Nghĩa Cử,
                  <br />
                  <span className="text-red-600">Trao Gửi Sự Sống</span>
                </h1>

                <p className="mt-5 max-w-md text-sm leading-7 text-slate-600 md:text-base">
                  SBDCs là hệ thống kết nối và quản lý hiến máu thông minh, giúp
                  người hiến tạo hồ sơ, kiểm tra điều kiện, đặt lịch và hỗ trợ
                  bệnh viện chủ động hơn trong điều phối nguồn máu.
                </p>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  >
                    Đăng ký hiến máu <ArrowRight className="h-4 w-4" />
                  </button>
                  <a
                    href="#process"
                ...
                <div style={{ borderRadius: 'calc(2rem - 3px)', background: '#fff', padding: '10px' }}>
                  <div className="relative w-full overflow-hidden" style={{ borderRadius: '1.5rem' }}>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: 11, fontWeight: 800, color: '#ef4444', letterSpacing: '0.05em' }}>HIẾN MÁU CỨU NGƯỜI</span>
                    </div>
        ...
        <section id="process" className="bg-[#f7f8fa] py-16">
          <SectionTitle
            title="Quy trình đăng ký hiến máu tại hệ thống"
            subtitle="Đơn giản, minh bạch và giúp bạn tiết kiệm thời gian khi đến bệnh viện."
          />
              ...
              <div style={{ borderRadius: 'calc(2rem - 3px)', background: '#fff', padding: '10px' }}>
                <div className="relative w-full overflow-hidden" style={{ borderRadius: '1.5rem' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#ef4444', display: 'inline-block', boxShadow: '0 0 0 3px rgba(239,68,68,0.2)' }} />
                    <span style={{ fontSize: 11, fontWeight: 800, color: '#ef4444', letterSpacing: '0.05em' }}>NGƯỜI ĐANG HIẾN MÁU</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#f5f2f4] py-16">
          <SectionTitle
            title="Cần tránh trước & sau khi hiến"
            subtitle="Đảm bảo cơ thể an toàn và chất lượng máu hiến tốt hơn."
          />
        ...
        <section id="about" className="bg-[#f6f8fb] py-16">
          <SectionTitle
            ...
            subtitle="Điều kiện cơ bản cho người hiến máu toàn phần, vui lòng tuân thủ tư vấn của nhân viên y tế."
          />
...
function Footer({ hospitalName, hospitalSubtitle }) {
  return (
    <footer className="bg-slate-200/80 py-12">
      ...
      <p className="mt-10 text-center text-xs font-semibold text-slate-400">
        © 2026 SBDCs - Smart Blood Donation Connection System.
      </p>
    </footer>
  );
}